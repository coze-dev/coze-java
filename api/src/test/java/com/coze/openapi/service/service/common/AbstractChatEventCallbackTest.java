...
class AbstractChatEventCallbackTest {
  ...
  void testSuccessfulStreamResponse() throws IOException {
    ...
    ResponseBody responseBody = ResponseBody.create(testData, MediaType.parse("text/event-stream"));
  ...
  void testJsonResponse() throws IOException {
    ...
    BaseResponse<String> baseResponse =
        BaseResponse.<String>builder().code(0).msg("success").data("test data").build();
