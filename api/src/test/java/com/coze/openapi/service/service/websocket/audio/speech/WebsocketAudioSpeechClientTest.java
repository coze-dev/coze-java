...
public class WebsocketAudioSpeechClientTest {
    ...
    public void setup() {
        ...
        WebsocketAudioSpeechCreateReq req = WebsocketAudioSpeechCreateReq.builder()
    ...
    public void testHandleSpeechAudioUpdateEvent() {
        ...
        verify(mockCallbackHandler).onSpeechAudioUpdate(eq(client), speechAudioUpdateEventCaptor.capture());
    ...
    public void testHandleSpeechAudioCompletedEvent() {
        ...
        verify(mockCallbackHandler).onSpeechAudioCompleted(eq(client), speechAudioCompletedEventCaptor.capture());
    ...
    public void testHandleInputTextBufferCompletedEvent() {
        ...
        verify(mockCallbackHandler).onInputTextBufferCompleted(eq(client), inputTextBufferCompletedEventCaptor.capture());
