...
public class WebsocketAudioTranscriptionsClientTest {
    ...
    @Captor private ArgumentCaptor<TranscriptionsMessageUpdateEvent> transcriptionsMessageUpdateEventCaptor;
    @Captor private ArgumentCaptor<TranscriptionsMessageCompletedEvent> transcriptionsMessageCompletedEventCaptor;
    ...
    public void setup() {
        ...
        WebsocketAudioTranscriptionsCreateReq req = WebsocketAudioTranscriptionsCreateReq.builder()
    ...
    public void testHandleTranscriptionsCreatedEvent() {
        ...
        verify(mockCallbackHandler).onTranscriptionsCreated(eq(client), transcriptionsCreatedEventCaptor.capture());
    ...
    public void testHandleTranscriptionsUpdatedEvent() {
        ...
        verify(mockCallbackHandler).onTranscriptionsUpdated(eq(client), transcriptionsUpdatedEventCaptor.capture());
    ...
    public void testHandleTranscriptionsMessageUpdateEvent() {
        ...
        verify(mockCallbackHandler).onTranscriptionsMessageUpdate(eq(client), transcriptionsMessageUpdateEventCaptor.capture());
    ...
    public void testHandleTranscriptionsMessageCompletedEvent() {
        ...
        verify(mockCallbackHandler).onTranscriptionsMessageCompleted(eq(client), transcriptionsMessageCompletedEventCaptor.capture());
        
        TranscriptionsMessageCompletedEvent event = transcriptionsMessageCompletedEventCaptor.getValue();
    ...
    public void testHandleInputAudioBufferClearedEvent() {
        ...
        verify(mockCallbackHandler).onInputAudioBufferCleared(eq(client), inputAudioBufferClearedEventCaptor.capture());
    ...
    public void testHandleInputAudioBufferCompletedEvent() {
        ...
        verify(mockCallbackHandler).onInputAudioBufferCompleted(eq(client), inputAudioBufferCompletedEventCaptor.capture());
