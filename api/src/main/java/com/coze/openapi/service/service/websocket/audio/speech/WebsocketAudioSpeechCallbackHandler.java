...
public abstract class WebsocketAudioSpeechCallbackHandler extends BaseCallbackHandler<WebsocketAudioSpeechClient> {
    public WebsocketAudioSpeechCallbackHandler() {}
    ...
    public void onSpeechAudioCompleted(WebsocketAudioSpeechClient client, SpeechAudioCompletedEvent event) {}

    // 文本缓冲区完成事件 (input_text_buffer.completed)
    public void onInputTextBufferCompleted(WebsocketAudioSpeechClient client, InputTextBufferCompletedEvent event) {}
}
